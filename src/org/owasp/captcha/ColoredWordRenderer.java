...
public class ColoredWordRenderer implements WordRenderer {
	...
	public ColoredWordRenderer() {
		this(DEFAULT_COLORS, DEFAULT_FONTS, DEFAULT_STROKE_WIDTH);
	}

	public ColoredWordRenderer(List<Color> colors, List<Font> fonts) {
	...
	public void render(final String word, BufferedImage image) {
		...
		for (int i = 0; i < word.length();) {
			as.addAttribute(TextAttribute.FONT, getRandomFont(), i, ++i);
			as.addAttribute(TextAttribute.SIZE, RAND.nextInt(10) + 40, i, ++i);
		}
